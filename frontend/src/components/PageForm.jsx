...
export default function PageForm() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto">
      <div className="rounded-3xl bg-gray-100 p-6 md:p-8 shadow-sm">
        <form onSubmit={handleSubmit}>
          <h3 className="text-xl font-semibold mb-6">{id ? "Edit Page" : "Add Page"}</h3>
          ...
          <div className="mt-8 flex items-center justify-end gap-4">
            ...
            <button
              ...
              className="px-6 py-3 rounded-xl bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-60"
            >
